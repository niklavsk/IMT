...
<div class="m-5">
    ...
    <h4>
        <strong>
            ...
            <strong>– Prep: Scheduled Meals and Basecamp</strong>
        </strong>
    </h4>
    <p>
    ...
    <p>
        <strong>B. Separate Base Camp</strong>&nbsp;
        <strong>(and the mandatory isolation phase)</strong>&nbsp;
    ...
    <ul>
        <li>
            <strong>Site swapping:</strong>&nbsp;This is where each cat gets to explore the other’s territory without ever
    ...
    <ul>
        <li>
            <strong>The “Other Side of the Door” Feeding Ritual</strong>
